...
# Effective batch = 32 × 2 = 64  →  ~63 steps/epoch  →  ~95k updates
#
# Trains with FPS subsampling: 15k-point clouds → 2048 points.
# KNN-local attention (k=32) keeps memory at O(N·K).
# 80 GB VRAM allows batch=32 and train_n_points=2048 without grad checkpointing.
#
...
BATCH_SIZE=32           # Per-GPU batch size (effective = 32 × 2 = 64); 80 GB allows this
