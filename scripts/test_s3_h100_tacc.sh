#!/bin/bash
#===========================================================================
# SLURM Job Script — Stampede3 H100: TESTING (Full-Resolution Inference)
...
#
# Submit with:  sbatch scripts/test_s3_h100_tacc.sh
#===========================================================================

#SBATCH -J rectflow-test-s3
...
if [ ! -f "$CHECKPOINT" ]; then
    ...
    echo "       Train a model first with: sbatch scripts/train_s3_h100_tacc.sh"
    exit 1
fi
