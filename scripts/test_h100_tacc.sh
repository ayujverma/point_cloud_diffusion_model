#!/bin/bash
#===========================================================================
# SLURM Job Script — TACC H100: TESTING (Full-Resolution Inference)
...
#
# Submit with:  sbatch scripts/test_h100_tacc.sh
#===========================================================================

#SBATCH -J rectflow-test-h100
...
if [ ! -f "$CHECKPOINT" ]; then
    ...
    echo "       Train a model first with: sbatch scripts/train_h100_tacc.sh"
    exit 1
fi
